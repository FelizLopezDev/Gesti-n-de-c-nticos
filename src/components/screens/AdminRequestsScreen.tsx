      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-6 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-stone-900 tracking-tight flex items-center gap-2.5">
              ...
              <span>{isUserViewOnly ? 'Mis Solicitudes de Acceso' : 'Gestión de Solicitudes de Acceso'}</span>
            ...
            <p className="text-sm text-stone-600 mt-1 max-w-2xl leading-relaxed">
              {isUserViewOnly
                ? 'Historial y estado de tus pedidos de canciones para salas de Google Meet.'
                : 'Revisa y autoriza de forma granular cada alabanza solicitada por los colaboradores para reuniones virtuales.'}
            </p>
          </div>
        ...
        <div className="mt-4 relative max-w-md">
          ...
          <input
            ...
            placeholder="Buscar por ID, solicitante, reunión o canción..."
